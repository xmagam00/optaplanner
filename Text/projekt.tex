...
\projectinfo{
  ...
  title.en={lanning Task Monitoring System}, %nazev prace v anglictine
  %Autor
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={Java EE 6, Java, SOA, Java Beans,Java Server Faces, Monitorovanie, Twitter, Bootstrap, Systém .}, %klicova slova v ceskem jazyce
  keywords.en={Java EE 6, Java, SOA, Java Beans,Java Server Faces, Monitoring, Twitter, Bootstrap, System.}, %klicova slova v anglickem jazyce
  %Abstract
  abstract.cs={.}, % abstrakt v ceskem jazyce
  abstract.en={Výtah (abstrakt) práce v anglickém jazyce.}, % abstrakt v anglickem jazyce
  %Prohlaseni
  declaration={Prohlašuji, že jsem tuto bakalářskou práci vypracoval samostatnì pod vedením pana Zděnka Letka},
