...
public class AdministratorBean {
	...
	public void runTask(TaskDef task) throws Exception_Exception {
		...
		long cislo = new Long(task.getId());
		OptaPlannerWebServiceService test = new OptaPlannerWebServiceService();
		OptaPlannerWebService op = test.getOptaPlannerWebServicePort();
		op.startTask(2);
		setRenderPoll("true");
	}
