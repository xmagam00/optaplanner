...
public class Operation {
	...
	*/	
     ...
     */
 	...
 	{
 		Query q = eManager.createQuery("select t.idTask,t.name,t.stateOfTask,t.progressOfTask,t.eta,t.ifpublic, u.username,t.xmlFile from Task t,User u where t.user = u.idUser");
 	...
 	public List<TaskDef>  selectTaskByUserWithOrganization(String username)
 	{
		...
		Query q  = eManager.createQuery("select organization from User where username='"+username +"'");
		Object result = q.getSingleResult();
		
		Query query = eManager.createQuery("select t.idTask,t.name,t.stateOfTask,t.progressOfTask,t.eta,t.ifpublic,t.xmlFile from Task t where t.organization=" + result.toString());
		List<TaskDef> todoList = query.getResultList();
 	      return todoList;
